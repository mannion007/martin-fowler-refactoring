...
use Mannion007\MartinFowlerRefactoring\AbstractMovie;
...
final class CustomerTest extends TestCase
{
    public function testStatementForSingleRegularMovieForOneDay()
    {
        ...
        $customer->addRental(new Rental(AbstractMovie::createRegular('Some Regular Movie'), 1));
    ...
    {
        $customer = new Customer('Bert Sampson');
        $customer->addRental(new Rental(AbstractMovie::createRegular('Some Regular Movie'), 5));
    ...
    public function testStatementForMultipleRegularMoviesForOneDay()
    {
        $customer = new Customer('Bert Sampson');
        $customer->addRental(new Rental(AbstractMovie::createRegular('Some Regular Movie'), 1));
        $customer->addRental(new Rental(AbstractMovie::createRegular('Another Regular Movie'), 1));
    ...
    public function testStatementForMultipleRegularMoviesForMultipleDays()
    {
        $customer = new Customer('Bert Sampson');
        $customer->addRental(new Rental(AbstractMovie::createRegular('Some Regular Movie'), 5));
        $customer->addRental(new Rental(AbstractMovie::createRegular('Another Regular Movie'), 6));
    ...
    {
        $customer = new Customer('Bert Sampson');
        $customer->addRental(new Rental(AbstractMovie::createNewRelease('Some New Release Movie'), 1));
    ...
    {
        $customer = new Customer('Bert Sampson');
        $customer->addRental(new Rental(AbstractMovie::createNewRelease('Some New Release Movie'), 5));
    ...
    public function testStatementForMultipleNewReleaseMovieForOneDay()
    {
        $customer = new Customer('Bert Sampson');
        $customer->addRental(new Rental(AbstractMovie::createNewRelease('Some New Release Movie'), 1));
        $customer->addRental(new Rental(AbstractMovie::createNewRelease('Another New Release Movie'), 1));
    ...
    public function testStatementForMultipleNewReleaseMovieForMultipleDays()
    {
        $customer = new Customer('Bert Sampson');
        $customer->addRental(new Rental(AbstractMovie::createNewRelease('Some New Release Movie'), 5));
        $customer->addRental(new Rental(AbstractMovie::createNewRelease('Another New Release Movie'), 5));
    ...
    {
        $customer = new Customer('Bert Sampson');
        $customer->addRental(new Rental(AbstractMovie::createChildrens("Some Children's Movie"), 1));
    ...
    {
        $customer = new Customer('Bert Sampson');
        $customer->addRental(new Rental(AbstractMovie::createChildrens("Some Children's Movie"), 5));
    ...
    public function testStatementForMultipleChildrenRentalForOneDay()
    {
        $customer = new Customer('Bert Sampson');
        $customer->addRental(new Rental(AbstractMovie::createChildrens("Some Children's Movie"), 1));
        $customer->addRental(new Rental(AbstractMovie::createChildrens("Another Children's Movie"), 1));
    ...
    public function testStatementForMultipleChildrenRentalForMultipleDays()
    {
        $customer = new Customer('Bert Sampson');
        $customer->addRental(new Rental(AbstractMovie::createChildrens("Some Children's Movie"), 5));
        $customer->addRental(new Rental(AbstractMovie::createChildrens("Another Children's Movie"), 5));
    ...
    {
        $customer = new Customer('Bert Sampson');
        $customer->addRental(new Rental(AbstractMovie::createRegular('Some Regular Movie'), 10));
        $customer->addRental(new Rental(AbstractMovie::createNewRelease('Some New Release Movie'), 10));
        $customer->addRental(new Rental(AbstractMovie::createChildrens("Some Children's Movie"), 10));
