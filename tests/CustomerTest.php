...
use Mannion007\MartinFowlerRefactoring\RegularMovie;
use Mannion007\MartinFowlerRefactoring\NewReleaseMovie;
use Mannion007\MartinFowlerRefactoring\ChildrensMovie;
use Mannion007\MartinFowlerRefactoring\PlainTextStatementGenerator;
...
final class CustomerTest extends TestCase
{
    public function testStatementForSingleRegularMovieForOneDay()
    {
        ...
        $this->assertSame("Rental Record for Bert Sampson\n\tSome Regular Movie\t2\nAmount owed is 2\nYou earned 1 frequent renter points", $customer->statement(new PlainTextStatementGenerator()));
    }
    ...
    public function testStatementForMultipleRegularMoviesForOneDay()
    {
        ...
        $this->assertSame("Rental Record for Bert Sampson\n\tSome Regular Movie\t2\n\tAnother Regular Movie\t2\nAmount owed is 4\nYou earned 2 frequent renter points", $customer->statement(new PlainTextStatementGenerator()));
    }
    ...
    public function testStatementForMultipleNewReleaseMovieForMultipleDays()
    {
        ...
        $this->assertSame("Rental Record for Bert Sampson\n\tSome New Release Movie\t15\n\tAnother New Release Movie\t15\nAmount owed is 30\nYou earned 4 frequent renter points", $customer->statement(new PlainTextStatementGenerator()));
    }
    ...
    public function testStatementForACombinationOfRentalsForOneDay()
    {
        ...
        $customer->addRental(new Rental(new NewReleaseMovie('Some New Release Movie'), 1));
        $customer->addRental(new Rental(new ChildrensMovie("Some Children's Movie"), 1));
        $this->assertSame("Rental Record for Bert Sampson\n\tSome Regular Movie\t2\n\tSome New Release Movie\t3\n\tSome Children's Movie\t1.5\nAmount owed is 6.5\nYou earned 3 frequent renter points", $customer->statement(new PlainTextStatementGenerator()));
    }
