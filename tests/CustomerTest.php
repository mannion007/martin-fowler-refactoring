...
final class CustomerTest extends TestCase
{
    ...
    public function testHtmlStatementForSingleRegularMovieForOneDay()
    {
        $customer = new Customer('Bert Sampson');
        $customer->addRental(new Rental(new RegularMovie('Some Regular Movie'), 1));
        $this->assertSame("<html><h1>Rental Record for Bert Sampson</h1><p>Some Regular Movie = 2</p><p><strong>Amount owed is 2</strong></p><p><strong>You earned 1 frequent renter points</strong></p></html>", $customer->statement(new HtmlStatementProducer()));
    }
}
